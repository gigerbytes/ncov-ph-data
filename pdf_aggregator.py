...
df_cases.columns = ["case_no", "age", "sex", "nationality", 'detailed_history', "date_symptoms", "date_admission","date_confirmation","facility","residence" ]



df_cases.to_csv('./data/cases_pdf_ph.csv')
